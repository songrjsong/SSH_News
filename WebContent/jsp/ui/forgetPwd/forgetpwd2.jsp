	...
	<div id="divMiddle">
		...
		<div id="div_status" class="login-user" style="display:none;"></div>
			   ...
			   <div class="web-width">
			     ...
			     <form action="${pageContext.request.contextPath }/user/findpwd2.form" method="get" class="forget-pwd">
			       <dl>
			       <dt>账号：</dt>
			       <dd><input type="text" name="inputType" placeholder="请输入手机号码或邮箱"/></dd>
			       <div class="clears"></div>
			      </dl> 
			       <dl>
			        <dt>新密码：</dt>
			        <dd><input type="password" name="newpwd1" id="newpwd1"/></dd>
			        <div class="clears"></div>
			       </dl> 
			       <dl>
			        <dt>确认密码：</dt>
			       ...
			       <div class="subtijiao"><input type="submit" value="提交" onClick="checkpwd()"/></div> 
			      </form><!--forget-pwd/-->
			   </div><!--web-width/-->
			  </div><!--content/-->
