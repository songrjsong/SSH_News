...
function showDate() {
	...
	var x = document.getElementById('txt_calendar').offsetLeft+600;
	var y = document.getElementById('txt_calendar').offsetTop + 450;
 ...
 * */
//日历最外层div样式
var outerStyle = "display: none;position: absolute;width: 315px;margin-top:10px;border: 1px solid #F7F7F7;border-radius: 5px;background-color: #F7F7F7;color: #4eccc4;padding-bottom: 20px;z-index:20;";
//日历控件最外层div
