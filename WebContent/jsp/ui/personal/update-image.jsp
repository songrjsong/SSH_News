...
<body >
	...
	<div id="divTop">
		...
		<div id="divNavBar">
			<ul>
				<li style="display: inline;"><a href="${pageContext.request.contextPath }/news/findAllNewsByStatus.form" style="color: #262626" >首页</a></li>
	...
	<div id="divMiddle">
		...
		<div class="user_big_holder">
			<div class="home_tab">
				...
				<a class="selected" href="${pageContext.request.contextPath}/jsp/ui/personal/update-image.jsp">修改头像</a>
				<a href="${pageContext.request.contextPath}/jsp/ui/personal/update-pwd.jsp">修改密码</a>
		
		
			</div>
			<form action="${pageContext.request.contextPath}/user/updateImg.form?userId=${userInfo.user_Id}" method="post" enctype="multipart/form-data">
			
				<div style="text-align: center;">
					<c:if test="${ empty userInfo.image}">
						<img src="${pageContext.request.contextPath }/jsp/ui/img/0.png" width="120" height="120" border="0" />
					</c:if>
					<c:if test="${ not empty userInfo.image}">
						<img src="${pageContext.request.contextPath }/jsp/ui/img/${userInfo.image }" width="120" height="120" border="0" />
					</c:if>
					<br/>
